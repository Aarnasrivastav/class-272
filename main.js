$(function () {
    ...
    function syncDrawingData(data) {
        ...
        if (data.textarea_color == 'white'){
            document.getElementById("text_area").style_backgroundcolor = 'white'
        }
        if (data.textarea_color == 'red'){
            document.getElementById("text_area").style_backgroundcolor = 'red'
        }
        if (data.textarea_color == 'yellow'){
            document.getElementById("text_area").style_backgroundcolor = 'yellow'
        }
        if (data.textarea_color == 'green'){
            document.getElementById("text_area").style_backgroundcolor = 'green'
        }
    }
